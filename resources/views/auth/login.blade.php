  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="input-group mb-3">
          <input type="password" id="password" name="password" required autocomplete="current-password" class="form-control  @error('password') is-invalid @enderror" placeholder="{{ __('Password') }}" >
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <div class="social-auth-links text-center mb-3 mt-5">
        {{-- <p>- OR -</p> --}}
        <strong>Copyright &copy; <?php echo date('Y') ?> Developed By <a href="https://adndigital.com.bd/" target="_blank">ADN Digital</a></strong>
