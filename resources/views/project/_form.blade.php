<div class="card-body">
    <div class="row">
      <div class="form-group col-md-6">
        <label for="">LC or TT Date * @if ($errors->has('lc_or_tt_date')) <small class="text-danger"> [ {{ $errors->first('lc_or_tt_date') }} ] </small> @endif</label>
        <input type="date" name="lc_or_tt_date" class="form-control" id="" placeholder="" value="{{ isset($projects)? $projects['lc_or_tt_date']:null }}">

      </div>
      <div class="form-group col-md-6">
        <label for="">Style Number Order Session * @if ($errors->has('style_number_and_order_session')) <small class="text-danger"> [ {{ $errors->first('style_number_and_order_session') }} ] </small> @endif</label>
    ...
    <div class="row">
      <div class="form-group col-md-6">
        <label for="">LC Number * @if ($errors->has('lc_number')) <small class="text-danger"> [ {{ $errors->first('lc_number') }} ] </small> @endif</label>
        <input type="number" name="lc_number" class="form-control" id="" placeholder="789" value="{{ isset($projects)? $projects['lc_number']:null }}" >
      </div>

      <div class="form-group col-md-6">
        <label for="">LC Value * @if ($errors->has('lc_value')) <small class="text-danger"> [ {{ $errors->first('lc_value') }} ] </small> @endif</label>
    ...
    <div class="row">
         <div class="form-group col-md-6">
           <label for="">Forwarded Lc value * @if ($errors->has('forward_lc_value')) <small class="text-danger"> [ {{ $errors->first('forward_lc_value') }} ] </small> @endif</label>
         ...
         <div class="form-group col-md-6">
           <label for="">Advanced Payment * @if ($errors->has('advanced_payment')) <small class="text-danger"> [ {{ $errors->first('advanced_payment') }} ] </small> @endif</label>
    ...
    <div class="row">
        <div class="form-group col-md-6">
          <label for="">Outstanding Payment * @if ($errors->has('outstanding_payment')) <small class="text-danger"> [ {{ $errors->first('outstanding_payment') }} ] </small> @endif</label>
        ...
        <div class="form-group col-md-6">
          <label for="">Freight Cost * @if ($errors->has('freight_cost')) <small class="text-danger"> [ {{ $errors->first('freight_cost') }} ] </small> @endif</label>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
      <label for="">Shipment Mode * @if ($errors->has('shipment_mode')) <small class="text-danger"> [ {{ $errors->first('shipment_mode') }} ] </small> @endif</label>
    ...
    <div class="form-group col-md-6">
      <label for="">Shipment Date * @if ($errors->has('shipment_date')) <small class="text-danger"> [ {{ $errors->first('shipment_date') }} ] </small> @endif</label>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
      <label for="">Final Invoice Of Manufacturer * @if ($errors->has('final_invoice_of_manufacturer')) <small class="text-danger"> [ {{ $errors->first('final_invoice_of_manufacturer') }} ] </small> @endif</label>
    ...
    <div class="form-group col-md-6">
      <label for="">Final Invoice Of Buyer * @if ($errors->has('final_invoice_amount_of_buyer')) <small class="text-danger"> [ {{ $errors->first('final_invoice_amount_of_buyer') }} ] </small> @endif</label>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
      <label for="">Amount Recieved * @if ($errors->has('amount_recieved')) <small class="text-danger"> [ {{ $errors->first('amount_recieved') }} ] </small> @endif</label>
    ...
    <div class="form-group col-md-6">
      <label for="">Profit Share With Shareholder * @if ($errors->has('profits_shared_with_shareholders')) <small class="text-danger"> [ {{ $errors->first('profits_shared_with_shareholders') }} ] </small> @endif</label>
...
<div class="row">
    <div class="form-group col-md-6">
      <label for="">Main Acoount Balanced * @if ($errors->has('main_account_balaced_after_profit')) <small class="text-danger"> [ {{ $errors->first('main_account_balaced_after_profit') }} ] </small> @endif</label>
    ...
    <div class="form-group col-md-6">
      <label for="">Payment Method * @if ($errors->has('payment_method')) <small class="text-danger"> [ {{ $errors->first('payment_method') }} ] </small> @endif</label>
...
<div class="row">
    <div class="form-group col-md-6">
      <label for="">Payment Record * @if ($errors->has('payment_record')) <small class="text-danger"> [ {{ $errors->first('payment_record') }} ] </small> @endif</label>
    ...
    <div class="form-group col-md-6">
      <label for="">Profit Share Outstanding * @if ($errors->has('profit_share_outstanding')) <small class="text-danger"> [ {{ $errors->first('profit_share_outstanding') }} ] </small> @endif</label>
...
<div class="row">
 ...
 {{--<div class="form-group col-md-6">
   <label for="">Total Profit Margin * @if ($errors->has('total_profit_margin')) <small class="text-danger"> [ {{ $errors->first('total_profit_margin') }} ] </small> @endif</label>
